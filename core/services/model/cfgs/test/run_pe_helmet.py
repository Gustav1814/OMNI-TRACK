...
VIDEO_URL_DEFAULT = (
    "https://ai-public-videos.s3.us-east-2.amazonaws.com/Inferenced+Videos/fall_and_helmet.mp4"
)


def _ensure_weights_path() -> Path:
    weights_path = Path(__file__).resolve().parents[3] / "inferenced_weights" / "helmet.pt"
