...
from sqlalchemy import Column, Integer, String, Boolean, DateTime, Float, JSON, Index
...
class Camera(Base):
    ...
    __table_args__ = (
        Index("ix_cameras_zone_active", "zone", "is_active"),
        Index("ix_cameras_type_active", "camera_type", "is_active"),
    )
